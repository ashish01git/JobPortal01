	...
	<div>
		...
		<div class="register-photo">	
            ...
            <form method="post">
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Sign Up</button></div><a href="Login.jsp" class="already">You already have an account? Login here.</a></form>
        </div>
    </div>
